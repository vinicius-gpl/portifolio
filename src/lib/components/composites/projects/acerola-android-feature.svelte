...
<article
	class="grid grid-cols-1 items-center gap-8 md:grid-cols-[1fr_1.1fr]"
	use:scrollScale={{ mode: 'scrub', startScale: 0.9, exitScale: 0.96 }}
>
	<div
		class="w-[80%] justify-self-center overflow-hidden rounded-[10px] border border-[var(--color-border)] bg-[var(--color-bg-elevated)] transition-shadow duration-300 hover:shadow-xl hover:shadow-[rgba(203,166,247,0.06)] md:order-2"
